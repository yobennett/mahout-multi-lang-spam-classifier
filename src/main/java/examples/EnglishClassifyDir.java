...
import classifier.spam.EnglishNaiveBayesClassifier;
...
public class EnglishClassifyDir {
	...
	public static void main(String... args) {
		try {
			...
			// set up a Naive Bayes classifier for English
			// in our case we are classifying String objects (i.e. posts)
			// which are classified into a label (spam, ham, unsure)
			Classifier<Label, String> classifier = new EnglishNaiveBayesClassifier("classifier.properties");
